...
public class ReflectionUtilsTest {
    ...
    public void setUp() throws Exception {
        parameters = CreateUserController.class.getMethod("createUser", UserDto.class).getParameters();
    ...
    public void createBeanObject() throws Exception {
        InputStream inputSteram = new FileInputStream(new File(testDirectory + "Http_POST.txt"));
        HttpRequest request = HttpFactory.init(inputSteram);
        assertThat(reflectionUtils.createBeanObject(UserDto.class, request)
                , is(new UserDto()
                        .setName("JaeSung")
